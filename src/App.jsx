...
<div className=" px-6 mt-[4.5rem] w-full ">
        ...
        <p className="text-lg pt-3">
          I'm a passionate  React.js and Next.js developer with a passion
           for crafting sleek and responsive web applications.
           Proficient in Tailwind CSS and adept at database management 
           with PostgreSQL and Supabase.
          <br />
        ...
        <div>
          ...
          <div className="bg-[#212123]  h-[220px]  rounded-lg text-black mt-4 k mb-4">
            ...
            <div className=" text-white ">
              <p className="font-bold grid justify-center">Web Development</p> </div>
              <p className="  px-2 text-white py-3 text-center ">Web developer with React Js and Next JS </p>
          ...
          <div className="bg-[#212123]  h-[220px]  rounded-lg text-black mt-4 k mb-4">
            ...
            <div className="px-1 text-white">
              <p className="font-bold  px-3 py-3 grid justify-center">Web UI</p></div>
              <p className="text-center text-white"> Web UI designer with Figma </p>
              </div>
...
<div className="email-options h-[100px] mt-4 w-full bg-[#212123] px-6 py-2 rounded-lg">
      ...
      <svg className="w-[25px] pt-1 text-[#FFBA08]" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
