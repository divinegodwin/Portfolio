...
<ScrollLink to = '#service' smooth={true}><svg className=" nav-icon w-[30px] hover:text-[#FFBA08]"  data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
